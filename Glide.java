...
public class Glide implements ComponentCallbacks2 {
    ...
    Glide(Context context, Engine engine2, MemoryCache memoryCache2, BitmapPool bitmapPool2, ArrayPool arrayPool2, RequestManagerRetriever requestManagerRetriever2, ConnectivityMonitorFactory connectivityMonitorFactory2, int logLevel, RequestOptionsFactory defaultRequestOptionsFactory2, Map<Class<?>, TransitionOptions<?, ?>> defaultTransitionOptions, List<RequestListener<Object>> defaultRequestListeners, boolean isLoggingRequestOriginsEnabled, boolean isImageDecoderEnabledForBitmaps, int hardwareBitmapFdLimit, int minHardwareDimension) {
        ...
        if (!isImageDecoderEnabledForBitmaps || Build.VERSION.SDK_INT < 28) {
            ...
            streamBitmapDecoder = new StreamBitmapDecoder(downsampler, arrayPool3);
        } else {
            ResourceDecoder<InputStream, Bitmap> streamBitmapDecoder2 = new InputStreamBitmapImageDecoderResourceDecoder();
            byteBufferBitmapDecoder = new ByteBufferBitmapImageDecoderResourceDecoder();
            streamBitmapDecoder = streamBitmapDecoder2;
        }
        ...
        ResourceDecoder<InputStream, Bitmap> resourceDecoder3 = streamBitmapDecoder;
        ...
        this.glideContext = new GlideContext(context, arrayPool2, registry4, new ImageViewTargetFactory(), defaultRequestOptionsFactory2, defaultTransitionOptions, defaultRequestListeners, engine2, isLoggingRequestOriginsEnabled, logLevel);
    }
