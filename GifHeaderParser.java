...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f59ix = readShort();
        this.header.currentFrame.f60iy = readShort();
        this.header.currentFrame.f58iw = readShort();
        this.header.currentFrame.f57ih = readShort();
        int packed = read();
        boolean z = false;
