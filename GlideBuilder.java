...
public final class GlideBuilder {
    ...
    public GlideBuilder setImageDecoderEnabledForBitmaps(boolean isEnabled) {
        ...
        this.isImageDecoderEnabledForBitmaps = isEnabled;
        return this;
    }
    ...
    public Glide build(Context context) {
        ...
        if (this.memorySizeCalculator == null) {
            this.memorySizeCalculator = new MemorySizeCalculator.Builder(context2).build();
        }
        ...
        ConnectivityMonitorFactory connectivityMonitorFactory2 = this.connectivityMonitorFactory;
        int i = this.logLevel;
        Glide.RequestOptionsFactory requestOptionsFactory = this.defaultRequestOptionsFactory;
        ...
        boolean z = this.isLoggingRequestOriginsEnabled;
        boolean z2 = this.isImageDecoderEnabledForBitmaps;
        int i2 = this.hardwareBitmapFdLimit;
        return new Glide(context, engine2, memoryCache2, bitmapPool2, arrayPool2, requestManagerRetriever, connectivityMonitorFactory2, i, requestOptionsFactory, map, list2, z, z2, i2, this.minHardwareDimension);
    }
}
